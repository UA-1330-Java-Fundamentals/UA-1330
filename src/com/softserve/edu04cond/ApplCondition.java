package com.softserve.edu04cond;
...
public class ApplCondition {
    public static final int MY_CONST = 37;
    ...
    public static void main(String[] args) throws IOException {
        ...
        */
        //
        /*-
        float f = 12.5f; // 12.5 is double by default
        f = f + (float) 1.1;
