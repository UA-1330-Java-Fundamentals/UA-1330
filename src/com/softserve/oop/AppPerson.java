...
public class AppPerson {
    ...
    public static void main(String[] args) {
        ...
        p1.output();
        System.out.println("A person's " +
                p1.getFirstName() + " " +
                p1.getLastName() + " age is " +
                p1.getAge());
        ...
        System.out.println("I changed name ! Now I'm " +
                p3.getFirstName() + " " +
                p3.getLastName());
        ...
        p5.input(sc,"Enter you first name ", "Enter your last name ", "Enter your birth year ");
