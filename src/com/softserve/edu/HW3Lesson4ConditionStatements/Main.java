...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(CheckRange.checkRangeWithConstants(n1, n2, n3));
        ...
        int num2 = sc.nextInt();
        int num3 = sc.nextInt();
        System.out.println("Maximum value among the three numbers is: " + MinAndMaxNumber.findMaxNumberBetweenThree(num1, num2, num3));
        System.out.println("Minimum value among the three numbers is: " + MinAndMaxNumber.findMinNumberBetweenThree(num1, num2, num3));
