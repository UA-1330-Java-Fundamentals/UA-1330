package com.softserve.edu23web;
...
// curl -X POST http://localhost:8080/hello  -H "accept: */*"   -H "Content-Type: application/json" -d "{\"email\": \"test@gmail.com\",  \"password\": \"user\"}"
// curl -X POST http://localhost:8080/hello  -H "accept: */*"   -d "email=test@gmail.com&password=user"
// curl -X PUT http://localhost:8080/hello  -H "accept: */*"   -d "email=test@gmail.com&password=user"
